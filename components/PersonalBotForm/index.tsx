"use client"
import NewsLatterBox from "./QRCode";
import { useRef } from "react";
import emailjs from '@emailjs/browser';
import { useState } from "react";

const PersonalBotForm = () => {
  ...
  const uploadForm = async(e) => {
    e.preventDefault();
    setLoading(true)
    await emailjs.sendForm("service_irsy5nj","template_evdk94h",form.current,{
                  ...
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-slate-300 dark:bg-slate-500 outline-none focus:outline-none">
                    ...
                    <div className="relative p-6 flex-auto">
                      <p className="my-4 text-blueGray-500 bg-slate-300 dark:bg-slate-500 text-lg leading-relaxed">
                        Thank You for reaching out us, We ill call you shortly.
                      </p>
                    </div>
                    {/*footer*/}
...
export default PersonalBotForm;
