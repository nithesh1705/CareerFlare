...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="wow fadeInUp shadow-three dark:bg-slate-800 relative z-10 rounded-sm bg-white p-8 sm:p-11 lg:p-8 xl:p-11 mt-10"
      data-wow-delay=".2s"
    >
      <br>
      </br>
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Stay informed with our latest news, announcements, and product releases. Subscribe now to receive exclusive content and updates directly to your inbox.
      </p>
      <div>
        <input
          type="text"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-fuchsia-500 px-9 py-4 text-base font-medium text-white duration-300 hover:bg-fuchsia-800/90"
        />
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#f400fc" : "#f400fc"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
