...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: (
      <svg width="40" height="41" viewBox="0 0 40 41" className="fill-current text-fuchsia-500">
        <path
          opacity="0.5"
    ...
    title: "Crafted for Career Exploration",
    paragraph:
  ...
  },
  {
    id: 1,
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current text-fuchsia-500">
        <path
          opacity="0.5"
    ...
    title: "Enhanced Skills Development",
    paragraph:
  ...
  },
  {
    ...
    title: "Informed Career Decisions",
    paragraph:
